                              ...
                              <div class="col-md-6">
                                ...
                                <div class="portlet box blue">
                                    ...
                                    <div class="portlet-body form">
                                           {!! Form::open(['url' =>'userChangePasswordInfo','method' => 'post','role' => 'form','class'=>'form-horizontal']) !!}
                                            <div class="form-body">
                                                ...
                                                <input type="hidden" name="id" value="<?php echo Session::get('affliate_login_id');?>">
                                                <div class="form-group">
