...
$admin_id    = Session::get('affliate_login_id');
        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
					...
					<!-- BEGIN LOGO -->
                    <div class="page-logo">
                        <a href="{{ URL::to('/affiliateDashboard') }}"><img src="{{ URL::to('public/assets/layouts/layout/img/logo.png') }}" alt="logo" class="logo-default" /></a>
                    ...
                    <div class="page-sidebar navbar-collapse collapse">
                        ...
                        <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="nav-item start">
                                <a href="{{URL::to('affiliateDashboard')}}" class="nav-link ">
                            ...
                            <li class="heading">
                             ...
                             <li class="nav-item">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    ...
                                    <span class="title">Buy Domain</span>
                                    <span class="arrow"></span>
                                </a>
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('buyDomain')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="sub-menu">
                                    <li class="nav-item">
                                        <a href="{{URL::to('balanceTransfer')}}" class="nav-link">
                                            <i class="icon-paper-plane"></i>
                                            <span class="title">Balance Transfer</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{URL::to('manageBalanceTransfer')}}" class="nav-link ">
                                            <i class="icon-settings"></i>
                                            <span class="title">Manage Balance Transfer</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
